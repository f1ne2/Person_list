...
class Controller:
    ...
    def del_contact(self, search_id_str: str):
        self.storage.delete_from_table(search_id_str)

    def load_for_add(self, new_contact_info: Person):
        self.storage.insert_into_table(new_contact_info)

    def load_for_edit(self, new_contact_info: Person, contact_id: str):
    ...
    def edt_contact(self, edit_id_str: str, info: Person):
        list_contacts = self.storage.get_all_contacts()
        self.edit_contact(edit_id_str, info, list_contacts)

    def edit_contact(self, edit_id_str: str, edit: Person, list_contacts: list):
